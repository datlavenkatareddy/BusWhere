...
function App() {
  return (
    <Router>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-gray-50 to-indigo-50 text-gray-900 font-sans selection:bg-blue-200">
        ...
        <main className="max-w-md mx-auto w-full p-4 md:p-6">
          <Routes>
